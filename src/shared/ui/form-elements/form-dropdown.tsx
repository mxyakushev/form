    ...
    <div ref={ref} className={`relative w-full ${className ?? ''}`}>
      <div className='z-0 relative flex'>
        ...
        <input
          ...
          className={`w-full px-3 pt-3.5 h-[50px] pb-3 font-light text-white rounded border placeholder:text-[#E0E0E0] placeholder:font-light pl-12 focus:ring-0 transition duration-300 text-left border-white focus:border-theme focus:bg-blackTransparent hover:border-theme ${
